...
class KernelCompiler {
  ...
  Future<CompilerOutput?> compile({
    ...
    // // Check if there's a native_assets.yaml
    // final File? nativeAssetsYamlFile =
    //     buildDir?.childDirectory('.dart_tool').childFile('native_assets.yaml');

    // String? nativeAssetsYamlUri;
    // if (nativeAssetsYamlFile != null && nativeAssetsYamlFile.existsSync()) {
    //   nativeAssetsYamlUri = nativeAssetsYamlFile.uri.toFilePath();

    //   _logger.printError(<String>[io.Platform.executable, io.Platform.script.toString(), ...io.Platform.executableArguments].join(' '));
    //   throw Exception(<String>[io.Platform.executable, io.Platform.script.toString(), ...io.Platform.executableArguments].join(' '));
    // }
    ...
    final List<String> command = <String>[
      ...
      // if (nativeAssetsYamlUri != null) ...<String>[
      //   '--native-assets',
      //   nativeAssetsYamlUri,
      // ],
